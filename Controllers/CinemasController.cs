...
public class CinemasController(ICinemaService cinemaService) : ControllerBase
{
    ...
    /// </summary>
    /// <remarks>
    /// This endpoint is restricted to super administrators.  
    /// Allows updating the <see cref="CinemaApprovalStatus"/> of a cinema (e.g., Approved, Pending, Rejected).
    /// </remarks>
    ...
    /// This endpoint is restricted to organizers or super administrators.
    /// </remarks>
    /// <param name="id">The UUID v7 of the cinema to update.</param>
